      ...
      <tbody class="bg-white divide-y divide-gray-200">
        ...
        >
          ...
          <td class="px-6 py-4 whitespace-nowrap">
            ...
            <!-- Show type on mobile when other columns are hidden -->
          ...
          <td class="px-6 py-4 whitespace-nowrap">
            <div class="flex items-center justify-center space-x-2">
              <button
                ...
                class="w-7 h-7 flex items-center justify-center rounded-full border border-gray-300 text-gray-600 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              ...
              <input
                ...
                min="0"
                max="9"
                class="w-12 text-center text-sm border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-red-500 focus:border-red-500"
