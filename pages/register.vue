  ...
  <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        ...
        <div v-if="showVerificationPrompt" class="space-y-6">
          <div class="text-center">
          ...
          <div class="space-y-4">
            <button
              ...
              :disabled="isLoading"
              class="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
  ...
  try {
    ...
    if (result.success) {
      if (result.requiresVerification) {
        ...
        // Direct login (fallback if verification disabled)
